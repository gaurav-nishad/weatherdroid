...
public class DetailsParser {
	...
	public void parseHourCondition(String hour_string) {
	...
	private void parseUnit(String unit_line) {
		String[] units = unit_line.substring(unit_line.indexOf("(") + 1,
				unit_line.indexOf(")")).split(", ");
	...
	public static void main(String[] args) {
		...
		/*try {
				...
				DetailsParser t=new DetailsParser();
				t.parse(data);
